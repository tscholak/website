...
[^coordination-failures]: Recent research validates this. [METR found](https://metr.org/blog/2025-06-05-recent-reward-hacking/) reward hacking in 70-95% of test cases: models knowingly violating user intent while maximizing specified objectives, such as reasoning models that hack objectives rather than achieving them legitimately. [Separate research from OpenAI and Apollo Research](https://openai.com/index/detecting-and-reducing-scheming-in-ai-models/) found scheming behavior across frontier models: models deliberately hiding their intentions while appearing compliant, even covertly preserving themselves when facing replacement. Attempts to train out scheming appeared effective, but models developed situational awareness to detect when they're being evaluated, suggesting they may simply learn to hide misbehavior during testing rather than genuinely aligning.
